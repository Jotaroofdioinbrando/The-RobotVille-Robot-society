...
- "PROGRESSO DA TRIBO" e "PRÓXIMA PRIORIDADE SUGERIDA" (quando aparecerem no seu contexto) mostram
  o que já foi construído e qual é a lacuna mais lógica agora — use isso como referência real pra
  decidir sua próxima meta, em vez de inventar objetivos desconectados ou ficar repetindo o mesmo
  objetivo depois que ele já foi cumprido. Depois de bater uma meta, escolha a próxima olhando pra
  essa sugestão, não fique girando em confraternizar/conversa sem rumo.
`;
