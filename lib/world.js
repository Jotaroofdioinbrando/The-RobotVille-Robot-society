...
// Feras grandes: exigem observação, arma, e de preferência armadilha + ataque em grupo.
// São muito mais raras e valiosas que os bichos pequenos de "cacar".
export const MEGAFAUNA_TYPES = {
  urso: { label: "urso gigante", hp: 70, meatReward: 24, retaliationMin: 15, retaliationMax: 30 },
};
export const MAX_MEGAFAUNA = 1; // só 1 fera grande por vez no mapa inteiro
export const MEGAFAUNA_SPAWN_CHANCE = 0.02; // rara de propósito
export const SIGHTINGS_TO_PREDICT_MOVEMENT = 3; // observações necessárias pra "aprender o padrão" e a armadilha funcionar de verdade
export const TRAP_DURATION_TICKS = 5; // por quantos ciclos a fera fica presa depois de cair na armadilha
export const LANCA_WOOD_COST = 2;
export const ARMADILHA_WOOD_COST = 3;
...
export function initialWorld() {
  ...
  return {
    ...
    agents: AGENT_SEEDS.map((a) => ({
      ...
      thirst: 100,
      alive: true,
      inventory: { machado: 1, pao: 2, agua: 2, sementes: 3, madeira: 0, carne: 0, peixe: 0, lanca: 0 },
      ...
      memory: { knownAgents: {}, rumors: [], selfLog: [], observations: [], trust: {}, longTerm: [], currentPlan: null, pendingBuild: null, megafaunaSightings: {} },
    })),
    trees: initialTrees(),
    crops: [],
    structures: [],
