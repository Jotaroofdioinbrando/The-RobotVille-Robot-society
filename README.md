...
- `lib/llm.js` — chamador genérico pra Cerebras/Mistral (mesmo formato de API da OpenAI) + um chamador específico pro Gemini
...
- Nomes de modelo (`CEREBRAS_MODEL`, `MISTRAL_MODEL`, `GEMINI_MODEL`) podem mudar com o
