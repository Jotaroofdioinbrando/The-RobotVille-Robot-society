...
um no **OpenRouter** e um no **Gemini** — vivem, tomam decisões e interagem entre si.
...
- `lib/llm.js` — chamador genérico pra Cerebras/OpenRouter (mesmo formato de API da OpenAI) + um chamador específico pro Gemini
...
- Nomes de modelo (`CEREBRAS_MODEL`, `OPENROUTER_MODEL`, `GEMINI_MODEL`) podem mudar com o
